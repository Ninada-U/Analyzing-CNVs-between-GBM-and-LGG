'''
This code was for our data ingestion pipeline before we used the TCGAbiolinks R package.
It is not used in any of our visualizations.
'''
...
# set filters to ingest data from TCGA.
        ...
        if d.is_dir():
            for f in d.iterdir():
                ...
                try:
                    ...
                    pass
                Path("./../../../data/raw/" + id[0]).mkdir(parents=True, exist_ok=True)
                try:
                    shutil.move(new_name, "./../../../data/raw/" + id[0])
                except shutil.Error:
                    pass
...
for d in Path().iterdir():
    ...
    concatenated_df.to_csv("./../interim/" + str(d) + ".txt", index=False)
